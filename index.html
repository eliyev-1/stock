...
<html lang="en">
  ...
  <body>
          ...
          <div class="nav__sign">
            ...
            <div class="profile">
              ...
              <div class="profile__list">
                <a href="./profileDetails.html"
                  ><span><i class="fa-solid fa-user"></i></span>
                  <h3>Profil detalları</h3></a
                >
                <a href="#"
                ...
                <a href="#"
                  ...
                  <h3>Redakt olunanlar</h3></a
                >
                <a href="#"
                  ><span><i class="fa-solid fa-bookmark"></i></span>
                  <h3>Kolleksiyalar</h3></a
                >
                <a href="#"
                  ><span><i class="fa-solid fa-dollar-sign"></i></span>
                  <h3>Satınalmalar</h3></a
                >
                <a href="#"
                  ><span><i class="fa-solid fa-palette"></i></span>
                  <h3>Redakt olunanlar</h3></a
                ...
                <a href="#"
                  ...
                  <h3>Şəxsi mesajlar</h3></a
                >
                <a class="account__exit"
    ...
    <div class="icon__detail__background">
      <div class="icon__detail__exit">
        <i class="fa-solid fa-x"></i>
      </div>

      <div class="icon__detail container">
        <div class="icon__detail__left">
          <div class="icon__detail__left__img">
            <svg
              version="1.1"
              id="mySvg"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 886.65 886.65"
              style="enable-background: new 0 0 886.65 886.65"
              xml:space="preserve"
            >
              <rect class="rect" />
              <g transform="scale(0.5)" transform-origin="center center">
                <path
                  d="M739.37,436.08c-59.15-6.72-93.96-34-114.43-63.13c43.24-57.72,114.2-60.19,114.2-60.19
		...
		c-9.15,71.59,12.82,108.8,42.28,127.7c-13.87,7.05-30.1,12.61-49.08,15.93C424.34,287.55,408.11,281.99,394.25,274.94z"
                />
                <path
                  d="M504.95,604.51c-15.71-3.28-34.39-4.22-56.55-2.05c15.43-139.75,145.31-144.28,145.31-144.28
		...
		c7.96,0.84,24.69,3.39,43.96,10.99C437.51,652.81,448.13,728.16,450.09,739.72z"
          ...
          <div class="icon__color">
            <input type="color" class="icon__color__picker" />
            <div class="icon__color__radio">
              <input name="color" type="radio" id="color1" value="#FF7D6A" />
              <label for="color1"></label>
              <input name="color" type="radio" id="color2" value="#FEB602" />
              <label for="color2"></label>
              <input name="color" type="radio" id="color3" value="#FFC0CB" />
              <label for="color3"></label>
              <input name="color" type="radio" id="color4" value="#FF7D6A" />
              <label for="color4"></label>
              <input name="color" type="radio" id="color5" value="#52D999" />
              <label for="color5"></label>
              <input name="color" type="radio" id="color6" value="#336AEA" />
              <label for="color6"></label>
            </div>
          </div>
          <div class="icon__background">
            <input type="color" class="background__color__picker" disabled />
            <input
              type="range"
              class="border__radius__range"
              min="0"
              max="50"
              value="0"
              disabled
            ...
            <input
              ...
              min="0"
              max="50"
              class="border__radius__range__input"
              disabled
            />
            <div class="icon__bg__color__radio">
              <input
                name="bgColor"
                type="radio"
                id="bgColor1"
              ...
              <input
                ...
                value="#336AEA"
              />
              <label for="bgColor6"></label>
            </div>
            <input type="checkbox" class="background__disabled__checkbox" />
          </div>
        </div>
        <div class="icon__detail__right">
          <div class="icon__detail__right__header">
            <h2>Minimaline icons</h2>
          </div>
          <div class="icon__detail__right__format">
            <div class="icon__detail__right__format__names">
              <div class="icon__detail__right__png__format">
                <input name="fileFormat" type="radio" id="png" checked />
                <label for="png">PNG</label>
              </div>
              <div class="icon__detail__right__svg__format">
                <input name="fileFormat" type="radio" id="svg" />
                <label for="svg">SVG</label>
              </div>
            </div>
            <div class="icon__detail__right__png__format__sizes">
              <div>
                <input name="iconSize" type="radio" id="px32" />
                <label for="px32">32PX</label>
              </div>
              <div>
                <input name="iconSize" type="radio" id="px64" />
                <label for="px64">32PX</label>
              </div>
            </div>
            <div class="icon__detail__right__svg__format__codes">
              <div class="svg__format__codes__header">
                <div class="svg__format__codes__header__left">
                  <div>
                    <input type="radio" id="html" checked />
                    <label for="html">HTML</label>
                  </div>
                </div>
                <div class="svg__format__codes__header__right">
                  <i class="fa-regular fa-copy"></i>
                </div>
              </div>
              <div class="svg__format__codes__tittle">
                <p></p>
              </div>
            </div>
          </div>
